// Relay Actuator Sketch for ESP32 - Smart Plugs Control
...
const char* mqtt_topic_command = "actuators/smart_plugs/1/command";  // Subscribe topic for commands
const char* mqtt_topic_status = "actuators/smart_plugs/1/status";    // Publish topic for status
...
void reconnect() {
  while (!client.connected()) {
    ...
    String clientId = "ESP32-SMART_PLUGS-";
    clientId += device_id;
    clientId += "-";
