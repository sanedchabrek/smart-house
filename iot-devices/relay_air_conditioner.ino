// Relay Actuator Sketch for ESP32 - Air Conditioner Control
...
const char* mqtt_topic_command = "actuators/air_conditioner/1/command";  // Subscribe topic for commands
const char* mqtt_topic_status = "actuators/air_conditioner/1/status";    // Publish topic for status
...
void reconnect() {
  while (!client.connected()) {
    ...
    String clientId = "ESP32-AIR_CONDITIONER-";
    clientId += device_id;
    clientId += "-";
