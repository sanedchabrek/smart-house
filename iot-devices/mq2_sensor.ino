// MQ-2 Gas Sensor Sketch for ESP32
// Publishes gas level data via MQTT

#include <WiFi.h>
#include <PubSubClient.h>

// Pin definitions
#define MQ2_PIN 34  // Analog pin connected to MQ-2 sensor
...
const char* mqtt_topic_data = "sensors/mq2/1/data";  // Publish topic for sensor data
...
void reconnect() {
  while (!client.connected()) {
    ...
    if (client.connect(clientId.c_str())) {
      ...
      // client.subscribe("sensors/mq2/1/config");
    } else {
