// Relay Actuator Sketch for ESP32 - Lights Control
...
const char* mqtt_topic_command = "actuators/lights/1/command";  // Subscribe topic for commands
const char* mqtt_topic_status = "actuators/lights/1/status";    // Publish topic for status
