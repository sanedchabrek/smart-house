// PIR Motion Sensor Sketch for ESP32
// Publishes motion detection status via MQTT

#include <WiFi.h>
#include <PubSubClient.h>

// Pin definitions
#define PIR_PIN 5  // Digital pin connected to PIR sensor
...
const char* mqtt_topic_data = "sensors/pir/1/data";  // Publish topic for sensor data
...
void reconnect() {
  while (!client.connected()) {
    ...
    if (client.connect(clientId.c_str())) {
      ...
      // client.subscribe("sensors/pir/1/config");
    } else {
